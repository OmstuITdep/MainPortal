...
class EmployeePermissions
{
    ...
    private $whiteList = array(
        ...
        'wkards' => array(
            ...
            36484 => array('name' => 'Стадников Денис', 'permissions' => array('faculty'=>'all','groups' => 'all')),
            31614 => array('name' => 'Ольга Васильевна', 'permissions' => array('faculty'=>'all','groups' => 'all')),
            33747 => array('name' => 'Литвинов Георгий', 'permissions' => array('faculty'=>'all','groups' => 'all')),
            30671 => array('name' => 'Трапезников Евгений', 'permissions' => array('faculty'=>'all','groups' => 'all')),
        )
    );
