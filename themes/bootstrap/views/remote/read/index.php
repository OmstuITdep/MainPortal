...
if (in_array(Yii::app()->user->getFnpp(), ReadController::$pastTaskFnpp)){
    echo '<div class="tab">
    <button class="tablinks" onclick="openSchedule(event, \'Now\')">Нынешнее расписание</button>
    <button class="tablinks" onclick="openSchedule(event, \'Recent\')">Предыдущее расписание</button>
</div>';
}
?>
